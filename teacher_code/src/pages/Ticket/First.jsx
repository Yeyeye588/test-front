      ...
      <Space direction="vertical" size="middle" style={{ display: 'flex' }}>
        ...
        <div style={{ textAlign: 'center' }}>
          <Space>
            ...
            <Button onClick={() => handleSubmit(TYPE_ENUM.INITIAL_REJECTION)} loading={submitLoading}>驳回</Button>
            <Button type="primary" onClick={() => handleSubmit(TYPE_ENUM.INITIAL_APPROVAL)} loading={submitLoading}>
              初审通过
            </Button>
          </Space>
        </div>
