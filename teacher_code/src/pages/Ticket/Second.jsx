      ...
      <Space direction="vertical" size="middle" style={{ display: 'flex' }}>
        ...
        <div style={{ textAlign: 'center' }}>
          <Space>
            ...
            <Button onClick={() => handleSubmit(TYPE_ENUM.REVIEW_REJECTION)} loading={submitLoading}>驳回</Button>
            <Button type="primary" onClick={() => handleSubmit(TYPE_ENUM.REVIEW_APPROVAL)} loading={submitLoading}>
            复审通过
            </Button>
          </Space>
        </div>
